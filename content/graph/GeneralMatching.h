 ...
 * Description: Implementation of Blossom Algorithm for matching in general graphs.
 * Usage: blossom b{num_vertices}; b.add_edge(i, j); ans = b.solve();
 * Time: O(N^3)
 * Status: tested by Monogon
 */
#pragma once
